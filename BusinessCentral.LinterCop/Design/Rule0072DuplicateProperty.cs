...
{
    [DiagnosticAnalyzer]
    public class Rule0072DuplicateProperty : DiagnosticAnalyzer
    {
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } = ImmutableArray.Create(DiagnosticDescriptors.Rule0072DuplicateProperty);
        ...
        public void AnalyzeSymbol(SymbolAnalysisContext context)
        {
            ...
            {
                context.ReportDiagnostic(Diagnostic.Create(DiagnosticDescriptors.Rule0072DuplicateProperty, propertySymbol.GetLocation(), propertySymbol.Name));
            }
        }
    }
}
