...
{
    [DiagnosticAnalyzer]
    public class Rule0073RedundantEditableProperty : DiagnosticAnalyzer
    {
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } = ImmutableArray.Create(DiagnosticDescriptors.Rule0073RedundantEditableProperty);
        ...
        public void AnalyzeSymbol(SymbolAnalysisContext context)
        {
            ...
            if ((pageValue.HasValue && !pageValue.Value) || (pageExtensionValue != null && pageExtensionValue.HasValue && !pageExtensionValue.Value))
                context.ReportDiagnostic(Diagnostic.Create(DiagnosticDescriptors.Rule0073RedundantEditableProperty, propertySymbol.GetLocation()));
        }
